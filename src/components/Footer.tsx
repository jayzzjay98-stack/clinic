                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
                        ...
                        <a
                            ...
                            className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white px-8 py-4 rounded-full font-semibold text-lg hover:shadow-xl hover:bg-[#22c55e] transition-all"
                        >
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mt-6">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 bg-[#1877F2] text-white px-6 py-3 rounded-full font-medium hover:shadow-lg hover:bg-[#166fe5] transition-all"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 bg-black text-white px-6 py-3 rounded-full font-medium hover:shadow-lg hover:bg-gray-800 transition-all"
                        >
